...
if [ $? -eq 0 ]; then
    ...
    perform a developer install of jupyterlab_plotly you must have jupyter notebook on
...
if [ $? -eq 0 ]; then
    ...
    perform a developer install of jupyterlab_plotly you must have jupyter lab on
